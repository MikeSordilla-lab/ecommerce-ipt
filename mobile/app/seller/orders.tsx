...
import { ActionRow, Button, Card, ChipRow, Hero, Loading, Money, Muted, Notice, Screen, SellerBottomNav, StatusChip, Subtitle } from "@/components/ui";
...
export default function SellerOrdersScreen() {
  ...
  return (
    <Screen bottomNav={<SellerBottomNav activeRoute="orders" />}>
      <Hero title="Orders" subtitle="Advance orders from pending to delivered." />
      ...
      {orders.length ? (
        ...
        <Notice tone="info" message="No seller orders yet." />
      )}
    </Screen>
  );
}
