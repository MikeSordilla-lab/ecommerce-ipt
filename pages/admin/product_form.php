...
try {
    ...
    if ($is_edit) {
        ...
        if (!$product) {
            ...
            redirect(SITE_URL . "/pages/admin/products.php");
        }
    }
...
<div class="container">
    <h1 class="h2 mb-4 text-heading"><?= $is_edit
        ? "Edit Product"
        : "Add New Product" ?></h1>
...
$cat["id"]
    ...
    : "" ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="4"><?= sanitize(
                                $product["description"] ?? "",
                            ) ?></textarea>
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?= SITE_URL ?>/pages/admin/products.php" class="btn btn-outline-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
